<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{ invalid: !hourlyRate.isValid }">
      ...
      />
      <p v-if="!hourlyRate.isValid">hourlyRate must not be empty</p>
    </div>
    <div class="form-control" :class="{ invalid: !areas.isValid }">
      <h3>Devolop favorite</h3>
      <div>
        <input
          type="checkbox"
          id="frontend"
        ...
        />
        <label for="frontend">Devolop frontend</label>
      </div>
      <div>
        <input
          type="checkbox"
          ...
          @blur="clearValidity('areas')"
        />
        <label for="backend">Devolop backend</label>
      </div>
      <div>
        <input
          type="checkbox"
          ...
          @blur="clearValidity('areas')"
        />
        <label for="career">Devolop career</label>
      </div>
